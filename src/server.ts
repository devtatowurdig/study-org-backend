...
const allowedOrigins = (process.env.ALLOWED_ORIGINS || "https://studyorg.frameworksenac.com.br,http://95.111.238.203:3070,http://localhost:4200,http://127.0.0.1:4200,http://localhost:3070,http://localhost:5173,http://localhost:3000")
  .split(",")
